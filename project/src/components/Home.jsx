...
const Home = () => {
  return (
    <div className='container text-white flex  sm:text-[10px] flex-row lg:pl-[5%]'>
           ...
           lg:pt-[15%] md:pt-[18%] sm:text-[10px] pt-[15%]  lg:py-[20%]'>
                    ...
                    <button class='bg-[#00df9a] md:w-[200px] sm:w-[200px] rounded-md font-medium my-6 md:mx-auto px-3 md:py-3 sm:py-3 text-black md:text-2xl sm:text-[10px] text-[15px]'>Hire Me</button>
                    </div>
